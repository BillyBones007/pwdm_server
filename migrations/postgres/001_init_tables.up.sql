...
CREATE TABLE IF NOT EXISTS card_data(uuid UUID NOT NULL, id SERIAL UNIQUE NOT NULL PRIMARY KEY, type INTEGER NOT NULL, title VARCHAR(255), num VARCHAR(20), date VARCHAR(7), cvc VARCHAR(3), first_name VARCHAR(100), last_name VARCHAR(100), tag VARCHAR(255), comment TEXT, deleted BOOLEAN DEFAULT false);
